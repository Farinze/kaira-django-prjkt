"""
Django settings for kairaprjkt project.
...
WSGI_APPLICATION = 'kairaprjkt.wsgi.application'
...
# Only required if your static files are outside the app directories
STATICFILES_DIRS = [
    BASE_DIR / 'kaira' / 'static',  # adjust if yours is different
]

# Required for production
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Required for optimized files
